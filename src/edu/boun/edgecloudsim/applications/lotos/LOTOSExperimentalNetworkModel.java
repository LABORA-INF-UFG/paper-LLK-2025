...
public class LOTOSExperimentalNetworkModel extends NetworkModel {
	...
	private static LOTOSExperimentalNetworkModel instance = null;
	...
	public LOTOSExperimentalNetworkModel(int _numberOfMobileDevices, String _simScenario) {
		super(_numberOfMobileDevices, _simScenario);
	}


	public static LOTOSExperimentalNetworkModel getInstance(int numOfMobileDevice, String simScenario) {
		if(instance == null) {
			instance = new LOTOSExperimentalNetworkModel(numOfMobileDevice, simScenario);
		}
		return instance;
	}

	public static LOTOSExperimentalNetworkModel getInstance() {
		return instance;
	}
    ...
    */
	...
	@Override
	public double getApUsage(int sourceDeviceId, int destDeviceId, Task task, int type/*1 for upload and 2 for download*/) {
		double tasksize = 0.0;
		if(type == 1)
			tasksize = task.getCloudletFileSize();
		else if (type == 2)
			tasksize = task.getCloudletOutputSize();
		return tasksize;
	}
	...
	public void uploadStarted(Location accessPointLocation, int destDeviceId) {
		...
		if(destDeviceId == SimSettings.CLOUD_DATACENTER_ID){
			...
			SimLogger.printLine("Error - unknoqn device id in LOTOSExperimentalNetworkModel.uploadStarted(. Terminating simulation...");
			System.exit(0);
		}
	}
	...
	public void uploadFinished(Location accessPointLocation, int destDeviceId) {
		if(destDeviceId == SimSettings.CLOUD_DATACENTER_ID){
			...
			SimLogger.printLine("Error - unknoqn device id in LOTOSExperimentalNetworkModel.uploadFinished(. Terminating simulation...");
			System.exit(0);
		}
	}
	...
	public void downloadStarted(Location accessPointLocation, int sourceDeviceId) {
		if(sourceDeviceId == SimSettings.CLOUD_DATACENTER_ID){
			...
			SimLogger.printLine("Error - unknoqn device id in LOTOSExperimentalNetworkModel.downloadStarted(. Terminating simulation...");
			System.exit(0);
		}
	}
	...
	public void downloadFinished(Location accessPointLocation, int sourceDeviceId) {
		if(sourceDeviceId == SimSettings.CLOUD_DATACENTER_ID){
			...
			SimLogger.printLine("Error - unknoqn device id in LOTOSExperimentalNetworkModel.downloadFinished(. Terminating simulation...");
			System.exit(0);
		}
	}
	...
	public int getWanClients(int accessPoint){
		return wanClients[accessPoint];
	}

	public int getWlanClients(int accessPoint){
		return wlanClients[accessPoint];
	}

	public int getManClients(){
		return manClients;
	}
	...
	public double getPoissonDownload(){
		return ManPoissonMeanForDownload;
	}

	public double getPoissonUpload(){
		return ManPoissonMeanForUpload;
	}

	public double getavgManTaskInputSize(){
		return avgManTaskInputSize;
	}
	public double getavgManTaskOutputSize(){
		return avgManTaskOutputSize;
	}

	public double getMANBand(){
		return MAN_BW;
	}
}
