...
public abstract class NetworkModel {
    ...
    */
	...
	public abstract double getApUsage(int sourceDeviceId, int destDeviceId, Task task, int type/*1 for upload and 2 for download*/);

	public abstract int getWanClients(int acessPoint);

	public abstract int getWlanClients(int acessPoint);

	public abstract int getManClients();
}
